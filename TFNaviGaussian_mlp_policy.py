...
from ConstantLayer import ConstantLayer


class TFNaviGaussianMLPPolicy(StochasticPolicy, LayersPowered, Serializable):
    def __init__(
            self,
            name,
            env_spec,
        ...
        with tf.variable_scope(name):
            ...
            super(TFNaviGaussianMLPPolicy, self).__init__(env_spec)
    ...
    def dist_info_sym(self, obs_var, state_info_vars=None):
        mean_var, std_param_var = L.get_output([self._l_mean, self.l_log_std], obs_var)
        if self.min_std_param is not None:
