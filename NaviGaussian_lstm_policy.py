...
class NaviGaussianLSTMPolicy(StochasticPolicy, LayersPowered, Serializable):
    def __init__(
            self,
            name,
            env_spec,
        ...
        with tf.variable_scope(name):
            ...
            super(NaviGaussianLSTMPolicy, self).__init__(env_spec)
            ...
            self.l_step_log_std  = l_step_log_std
